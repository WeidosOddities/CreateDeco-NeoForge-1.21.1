...
public class Windows {
  ...
  public static BlockEntry<WindowBlock> metalWindowBlock(String metal,
    ...
    NonNullFunction<String, ResourceLocation> end_texture = $ -> CreateDecoMod.asResource(palettesDir() + $);
    NonNullFunction<String, ResourceLocation> side_texture = n -> CreateDecoMod.asResource(palettesDir() + n);
  ...
  public static BlockEntry<ConnectedGlassPaneBlock> metalWindowPane(String metal,
    ...
    ResourceLocation topTexture = CreateDecoMod.asResource(palettesDir() + name + "_end");
    ResourceLocation sideTexture = CreateDecoMod.asResource(palettesDir() + name);
  ...
  private static <G extends GlassPaneBlock> BlockEntry<G> glassPane(String name, Supplier<? extends Block> parent,
    ...
    return CreateDecoMod.REGISTRATE.block(name, factory)
        ...
        .loot((t, g) -> t.dropWhenSilkTouch(g))
        .item()
        .model((c, p) -> p.withExistingParent(c.getName(), CreateDecoMod.asResource("item/pane"))
